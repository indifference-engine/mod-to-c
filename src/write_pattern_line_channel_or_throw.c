...
void write_pattern_line_channel_or_throw(const uint8_t pattern_index,
  ...
  case EFFECT_TYPE_VIBRATO:
    write_or_throw("              %s(%s(%s), %s(%d), %s(%d), %s(%d), %s(%d), "
                   ...
                   pattern_index_macro_name, pattern_index,
                   line_index_macro_name, line_index, channel_index_macro_name,
                   channel_index, sixty_fourth_loops_per_tick_macro_name,
  ...
  case EFFECT_TYPE_VOLUME_SLIDE_VIBRATO:
    if (effect_x == 0) {
      write_or_throw("              %s(%s(%s), %s(%d), %s(%d), %s(%d), "
                     "%s(%d))\n            )",
      ...
      throw("Simultaneous volume slide up and down (as part of vibrato) in "
            "channel %d of line %d "
            "of pattern %d.",
            channel_index + 1, line_index + 1, pattern_index + 1);
    }
  ...
  case EFFECT_TYPE_TREMOLO:
    write_or_throw("              %s(%s(%s), %s(%d), %s(%d), %s(%d), %s(%d), "
                   ...
                   line_index_macro_name, line_index, channel_index_macro_name,
                   channel_index, sixty_fourth_loops_per_tick_macro_name,
                   effect_x, volumes_macro_name, effect_y);
    break;
  ...
  case EFFECT_TYPE_SAMPLE_OFFSET:
    write_or_throw("              %s(%s(%s), %s(%d), %s(%d), %s(%d), %s(%d))\n "
                   ...
                   song_name, pattern_index_macro_name, pattern_index,
                   line_index_macro_name, line_index, channel_index_macro_name,
                   channel_index, sample_index_macro_name, effect_xy * 256);
    break;
  ...
  case EFFECT_TYPE_VOLUME:
    ...
    write_or_throw("              %s(%s(%s), %s(%d), %s(%d), %s(%d), %s(%d))\n "
                   ...
                   pattern_index_macro_name, pattern_index,
                   line_index_macro_name, line_index, channel_index_macro_name,
                   channel_index, volume_macro_name, effect_xy);
    break;
  ...
  case EFFECT_TYPE_EXTRA:
    ...
    case EFFECT_TYPE_EXTRA_FINETUNE:
      write_or_throw(
          "              %s(%s(%s), %s(%d), %s(%d), %s(%d), "
          "%s(%d))\n            )",
          fine_tune_effect_macro_name, song_name_macro_name, song_name,
          pattern_index_macro_name, pattern_index, line_index_macro_name,
          line_index, channel_index_macro_name, channel_index,
          fine_tuning_macro_name, effect_y > 7 ? effect_y - 16 : effect_y);
      break;
    ...
    case EFFECT_TYPE_EXTRA_VIBRATO_WAVEFORM:
      ...
      case 0:
        write_or_throw(
            "              %s(%s(%s), %s(%d), %s(%d), %s(%d))\n            )",
            retriggering_sine_vibrato_effect_macro_name, song_name_macro_name,
            song_name, pattern_index_macro_name, pattern_index,
            line_index_macro_name, line_index, channel_index_macro_name,
            channel_index);
        break;
      ...
      case 2:
        write_or_throw(
            "              %s(%s(%s), %s(%d), %s(%d), %s(%d))\n            )",
            retriggering_square_vibrato_effect_macro_name, song_name_macro_name,
            song_name, pattern_index_macro_name, pattern_index,
            line_index_macro_name, line_index, channel_index_macro_name,
            channel_index);
        break;
      ...
      case 3:
        write_or_throw(
            "              %s(%s(%s), %s(%d), %s(%d), %s(%d))\n            )",
            retriggering_random_vibrato_effect_macro_name, song_name_macro_name,
            song_name, pattern_index_macro_name, pattern_index,
            line_index_macro_name, line_index, channel_index_macro_name,
            channel_index);
        break;
      ...
      case 5:
        write_or_throw(
            "              %s(%s(%s), %s(%d), %s(%d), %s(%d))\n            )",
            continuous_sawtooth_vibrato_effect_macro_name, song_name_macro_name,
            song_name, pattern_index_macro_name, pattern_index,
            line_index_macro_name, line_index, channel_index_macro_name,
            channel_index);
        break;
      ...
      case 6:
        write_or_throw(
            "              %s(%s(%s), %s(%d), %s(%d), %s(%d))\n            )",
            continuous_square_vibrato_effect_macro_name, song_name_macro_name,
            song_name, pattern_index_macro_name, pattern_index,
            line_index_macro_name, line_index, channel_index_macro_name,
            channel_index);
        break;
      ...
      case 7:
        write_or_throw(
            "              %s(%s(%s), %s(%d), %s(%d), %s(%d))\n            )",
            continuous_random_vibrato_effect_macro_name, song_name_macro_name,
            song_name, pattern_index_macro_name, pattern_index,
            line_index_macro_name, line_index, channel_index_macro_name,
            channel_index);
        break;
    ...
    case EFFECT_TYPE_EXTRA_PATTERN_LOOP:
      if (effect_y == 0) {
        ...
        write_or_throw(
            ...
            song_name, pattern_index_macro_name, pattern_index,
            line_index_macro_name, line_index, channel_index_macro_name,
            channel_index, repeats_macro_name, effect_y);
      }
      break;
    ...
    case EFFECT_TYPE_EXTRA_NOTE_CUT:
      write_or_throw("              %s(%s(%s), %s(%d), %s(%d), %s(%d), "
                     ...
                     song_name, pattern_index_macro_name, pattern_index,
                     line_index_macro_name, line_index,
                     channel_index_macro_name, channel_index, ticks_macro_name,
                     effect_y);
      break;
  ...
  case EFFECT_TYPE_SPEED:
    write_or_throw("              %s(%s(%s), %s(%d), %s(%d), %s(%d), %s(%d))\n "
                   ...
                   pattern_index_macro_name, pattern_index,
                   line_index_macro_name, line_index, channel_index_macro_name,
                   channel_index, delay_ticks_macro_name, effect_xy);
    break;
  }
}
